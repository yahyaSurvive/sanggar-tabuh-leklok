        ...
        <div class="container">
            <div class="row g-5 align-items-center">
                <div class="col-lg-7 col-md-12">
                    <small
                        class="d-inline-block fw-bold text-dark text-uppercase bg-light border border-primary rounded-pill px-4 py-1 mb-4 animated bounceInDown">Beranda
                    </small>
                    <h1 class="display-1 mb-4 animated bounceInDown"> <span class="text-primary text-lg">Selamat datang di
                        </span> Sanggar
                        Tabuh Leklok</h1>
                    <a href=""
