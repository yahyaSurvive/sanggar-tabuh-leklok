         ...
         <nav class="navbar navbar-light navbar-expand-lg py-4">
             ...
             <div class="collapse navbar-collapse" id="navbarCollapse">
                 <div class="navbar-nav mx-auto">
                     <a href="{{ route('/') }}"
                         class="nav-item nav-link {{ Route::currentRouteName() === '/' ? 'active' : '' }}">Home</a>
                     <a href="{{ route('about-us') }}"
                         class="nav-item nav-link {{ Route::currentRouteName() === 'about-us' ? 'active' : '' }}">About</a>
                     <a href="{{ route('activity') }}"
                         class="nav-item nav-link {{ Route::currentRouteName() === 'activity' ? 'active' : '' }}">Aktivitas</a>
