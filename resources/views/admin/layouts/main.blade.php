...
<head>
    ...
    <!-- Theme JS files -->
    <script src="{{ asset('assets/admin/assets/js/vendor/visualization/d3/d3.min.js') }}"></script>
    <script src="{{ asset('assets/admin/assets/js/vendor/visualization/d3/d3_tooltip.js') }}"></script>
...
<body>
    ...
    <div class="navbar navbar-dark navbar-expand-lg navbar-static border-bottom border-bottom-white border-opacity-10">
        <div class="container-fluid">
            ...
            <ul class="nav flex-row">
                ...
                <li class="nav-item nav-item-dropdown-lg dropdown ms-lg-2">
                    <a href="#" class="navbar-nav-link navbar-nav-link-icon rounded-pill"
                        ...
                        <i class="ph-chats"></i>
                        <span
                            class="badge bg-yellow position-absolute translate-middle-top zindex-1 rounded-pill end-0 top-0 me-1 mt-1 text-black">8</span>
                    </a>
            ...
            <div class="navbar-collapse justify-content-center flex-lg-1 order-lg-1 collapse order-2"
                id="navbar_search">
                <div class="navbar-search flex-fill position-relative mt-lg-0 mx-lg-3 mt-2">
                    <div class="form-control-feedback form-control-feedback-start flex-grow-1"
                        data-color-theme="dark">
                        <input type="text" class="form-control rounded-pill bg-transparent" placeholder="Search"
                            data-bs-toggle="dropdown">
                        <div class="form-control-feedback-icon">
                            <i class="ph-magnifying-glass"></i>
                        </div>
                        <div class="dropdown-menu w-100" data-color-theme="light">
                            <button type="button" class="dropdown-item">
                                <div class="w-32px me-3 text-center">
                                    <i class="ph-magnifying-glass"></i>
                                </div>
                    ...
                    <a href="#"
                        class="navbar-nav-link align-items-center justify-content-center w-40px h-32px rounded-pill position-absolute top-50 translate-middle-y end-0 me-1 p-0"
                        data-bs-toggle="dropdown" data-bs-auto-close="outside">
            ...
            <ul class="nav justify-content-end order-lg-2 order-1 flex-row">
                <li class="nav-item ms-lg-2">
                    <a href="#" class="navbar-nav-link navbar-nav-link-icon rounded-pill"
                        ...
                        <i class="ph-bell"></i>
                        <span
                            class="badge bg-yellow position-absolute translate-middle-top zindex-1 rounded-pill end-0 top-0 me-1 mt-1 text-black">2</span>
                    </a>
                </li>
                ...
                <div class="sidebar-section">
                    <ul class="nav nav-sidebar" data-nav-type="accordion">
                        ...
                        <li class="nav-item-header">
                            <div class="text-uppercase fs-sm lh-sm sidebar-resize-hide opacity-50">Forms</div>
                            <i class="ph-dots-three sidebar-resize-show"></i>
                        </li>
                        <li class="nav-item nav-item-submenu">
                            <a href="#" class="nav-link">
                            ...
                            <ul class="nav-group-sub collapse">
                                <li class="nav-item"><a href="form_autocomplete.html"
                                        class="nav-link">Autocomplete</a></li>
                                ...
                                <li class="nav-item"><a href="form_validation_styles.html"
                                        class="nav-link">Validation styles</a></li>
                                <li class="nav-item"><a href="form_validation_library.html"
                                        class="nav-link">Validation library</a></li>
                            </ul>
                        </li>
                        <li class="nav-item nav-item-submenu">
                            <a href="#" class="nav-link">
                        ...
                        <!-- Components -->
                        <li class="nav-item-header">
                            <div class="text-uppercase fs-sm lh-sm sidebar-resize-hide opacity-50">Components</div>
                            <i class="ph-dots-three sidebar-resize-show"></i>
                        </li>
                        <li class="nav-item nav-item-submenu">
                            <a href="#" class="nav-link">
                        ...
                        <!-- Layout -->
                        <li class="nav-item-header">
                            <div class="text-uppercase fs-sm lh-sm sidebar-resize-hide opacity-50">Layout</div>
                            <i class="ph-dots-three sidebar-resize-show"></i>
                        </li>
                        <li class="nav-item nav-item-submenu">
                            <a href="#" class="nav-link">
                        ...
                        <!-- Data visualization -->
                        <li class="nav-item-header">
                            <div class="text-uppercase fs-sm lh-sm sidebar-resize-hide opacity-50">Data visualization
                            </div>
                            <i class="ph-dots-three sidebar-resize-show"></i>
                        </li>
                        <li class="nav-item nav-item-submenu">
                        ...
                        <li class="nav-item nav-item-submenu">
                            ...
                            <ul class="nav-group-sub collapse">
                                ...
                                <li class="nav-item"><a href="maps_vector.html" class="nav-link disabled">D3.js
                                        maps <span class="badge align-self-center ms-auto bg-transparent">Coming
                                            soon</span></a></li>
                            </ul>
                        </li>
                        <!-- /data visualization -->
                        ...
                        <!-- Extensions -->
                        <li class="nav-item-header">
                            <div class="text-uppercase fs-sm lh-sm sidebar-resize-hide opacity-50">Extensions</div>
                            <i class="ph-dots-three sidebar-resize-show"></i>
                        </li>
                        <li class="nav-item nav-item-submenu">
                            <a href="#" class="nav-link">
                        ...
                        <!-- Tables -->
                        <li class="nav-item-header">
                            <div class="text-uppercase fs-sm lh-sm sidebar-resize-hide opacity-50">Tables</div>
                            <i class="ph-dots-three sidebar-resize-show"></i>
                        </li>
                        <li class="nav-item nav-item-submenu">
                            <a href="#" class="nav-link">
                        ...
                        <li class="nav-item nav-item-submenu">
                            ...
                            <ul class="nav-group-sub collapse">
                                ...
                                <li class="nav-item"><a href="gridjs_customizing.html"
                                        class="nav-link">Customizing</a></li>
                        ...
                        <!-- Page kits -->
                        <li class="nav-item-header">
                            <div class="text-uppercase fs-sm lh-sm sidebar-resize-hide opacity-50">Page kits</div>
                            <i class="ph-dots-three sidebar-resize-show"></i>
                        </li>
                        <li class="nav-item nav-item-submenu">
                            <a href="#" class="nav-link">
                        ...
                        <li class="nav-item nav-item-submenu">
                            ...
                            <ul class="nav-group-sub collapse">
                                ...
                                <li class="nav-item"><a href="widgets_menu.html" class="nav-link disabled">Menu
                                        widgets <span class="badge align-self-center ms-auto bg-transparent">Coming
                                            soon</span></a></li>
                ...
                <div class="page-header page-header-light shadow">
                    <div class="page-header-content d-lg-flex">
                        <div class="d-flex">
                            ...
                            <a href="#page_header"
                                class="btn btn-light align-self-center collapsed d-lg-none rounded-pill ms-auto border-transparent p-0"
                                data-bs-toggle="collapse">
                                <i class="ph-caret-down collapsible-indicator ph-sm m-1"></i>
                            </a>
                        </div>

                        <div class="d-lg-block my-lg-auto ms-lg-auto collapse" id="page_header">
                            <div class="d-sm-flex align-items-center mb-lg-0 ms-lg-3 mb-3">
                                <div class="dropdown w-100 w-sm-auto">
                                    ...
                                    <div
                                        ...
                                        <a href="#" class="dropdown-item py-2">
                                            <img src="../../../assets/images/brands/klm.svg"
                                                class="w-32px h-32px me-2" alt="">
                                            <div>
                                        ...
                                        <a href="#" class="dropdown-item py-2">
                                            <img src="../../../assets/images/brands/bp.svg"
                                                class="w-32px h-32px me-2" alt="">
                                            <div>
                                ...
                                <div class="vr d-none d-sm-block mx-3 my-2 flex-shrink-0"></div>

                                <div class="d-inline-flex mt-sm-0 mt-3">
                    ...
                    <div class="page-header-content d-lg-flex border-top">
                        ...
                        <div class="d-lg-block ms-lg-auto collapse" id="breadcrumb_elements">
                            <div class="d-lg-flex mb-lg-0 mb-2">
                                ...
                                <div class="dropdown ms-lg-3">
                                    <a href="#"
                                        class="d-flex align-items-center text-body dropdown-toggle py-2"
                                        data-bs-toggle="dropdown">
                                        <i class="ph-gear me-2"></i>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <div class="d-flex align-items-center justify-content-center mb-2">
                                                <a href="#"
                                                    class="bg-success text-success lh-1 rounded-pill me-3 bg-opacity-10 p-2">
                                                    <i class="ph-plus"></i>
                                                </a>
                                                <div>
                                        ...
                                        <div class="col-sm-4">
                                            <div class="d-flex align-items-center justify-content-center mb-2">
                                                <a href="#"
                                                    class="bg-warning text-warning lh-1 rounded-pill me-3 bg-opacity-10 p-2">
                                                    <i class="ph-clock"></i>
                                                </a>
                                                <div>
                                        ...
                                        <div class="col-sm-4">
                                            <div class="d-flex align-items-center justify-content-center mb-2">
                                                <a href="#"
                                                    class="bg-indigo text-indigo lh-1 rounded-pill me-3 bg-opacity-10 p-2">
                        ...
                        <div class="col-xl-5">
                            ...
                            <div class="card">
                                <div class="card-header d-sm-flex align-items-sm-center py-sm-0">
                                    ...
                                    <div class="mt-sm-0 ms-sm-auto mt-2">
                        ...
                        <div class="col-xl-8">
                                ...
                                <div
                                    ...
                                    <div class="d-flex align-items-center mb-sm-0 mb-3">
                                        ...
                                        <div class="ms-3">
                                            ...
                                            <span class="d-inline-block bg-success rounded-pill me-1 p-1"></span>
                                    ...
                                    <div class="d-flex align-items-center mb-sm-0 mb-3">
                                        ...
                                        <div class="ms-3">
                                            ...
                                            <span class="d-inline-block bg-danger rounded-pill me-1 p-1"></span>
                                    ...
                                    <table class="text-nowrap table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            ...
                                                            <div class="text-muted fs-sm">
                                                                <span
                                                                    class="d-inline-block bg-primary rounded-pill me-1 p-1"></span>
                                                                02:00 - 03:00
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <td><span
                                                        class="badge bg-primary text-primary bg-opacity-10">Active</span>
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            ...
                                                            <div class="text-muted fs-sm">
                                                                <span
                                                                    class="d-inline-block bg-danger rounded-pill me-1 p-1"></span>
                                                                13:00 - 14:00
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <td><span
                                                        class="badge bg-danger text-danger bg-opacity-10">Closed</span>
                                                </td>
                                                <td class="text-center">
                                                    <div class="dropdown">
                                                        <a href="#" class="text-body"
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            ...
                                                            <div class="text-muted fs-sm">
                                                                <span
                                                                    class="d-inline-block bg-secondary rounded-pill me-1 p-1"></span>
                                                                10:00 - 11:00
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <td><span class="badge bg-secondary text-secondary bg-opacity-10">On
                                                        hold</span></td>
                                                <td class="text-center">
                                                    <div class="dropdown">
                                                        <a href="#" class="text-body"
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            ...
                                                            <div class="text-muted fs-sm">
                                                                <span
                                                                    class="d-inline-block bg-success rounded-pill me-1 p-1"></span>
                                                                15:00 - 16:00
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <td><span
                                                        class="badge bg-success text-success bg-opacity-10">Pending</span>
                                                </td>
                                                <td class="text-center">
                                                    <div class="dropdown">
                                                        <a href="#" class="text-body"
                                    ...
                                    <div class="card bg-teal text-white">
                                        <div class="card-body">
                                            <div class="d-flex">
                                                ...
                                                <span
                                                    class="badge rounded-pill align-self-center ms-auto bg-black bg-opacity-50">+53,6%</span>
                                            </div>
                                        ...
                                        <div class="rounded-bottom mx-3 overflow-hidden" id="members-online"></div>
                                    </div>
                                    <!-- /members online -->
                                        ...
                                        <div class="card-body">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="dropdown d-inline-flex ms-auto">
                                                    <a href="#"
                                                        class="d-inline-flex align-items-center dropdown-toggle text-white"
                                                        data-bs-toggle="dropdown">
                                                        <i class="ph-gear"></i>
                                                    </a>
                                                    <div class="dropdown-menu dropdown-menu-end">
                            ...
                            <div class="card">
                                ...
                                <div
                                    ...
                                    <div class="d-flex align-items-center mb-lg-0 mb-3">
                                        <a href="#"
                                            class="bg-primary text-primary lh-1 rounded-pill bg-opacity-10 p-2">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <a href="#"
                                                            class="d-inline-flex align-items-center justify-content-center bg-teal lh-1 rounded-pill w-40px h-40px me-3 text-white">
                                                        ...
                                                        <div>
                                                            ...
                                                            <div class="d-flex align-items-center text-muted fs-sm">
                                                                <span class="bg-danger rounded-pill me-2 p-1"></span>
                                                                Blocker
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <a href="#" class="text-body fw-semibold">Chris
                                                                Macintyre</a>
                                                            <div class="d-flex align-items-center text-muted fs-sm">
                                                                <span class="bg-primary rounded-pill me-2 p-1"></span>
                                                                Medium
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <a href="#"
                                                            class="d-inline-flex align-items-center justify-content-center bg-primary lh-1 rounded-pill w-40px h-40px me-3 text-white">
                                                            <span class="letter-icon"></span>
                                                        </a>
                                                        <div>
                                                            <a href="#"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <a href="#"
                                                            class="d-inline-flex align-items-center justify-content-center bg-warning lh-1 rounded-pill w-40px h-40px me-3 text-white">
                                                            <span class="letter-icon"></span>
                                                        </a>
                                                        <div>
                                                            <a href="#"
                                                                ...
                                                                Hauber</a>
                                                            <div class="d-flex align-items-center text-muted fs-sm">
                                                                <span class="bg-warning rounded-pill me-2 p-1"></span>
                                                                High
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <a href="#"
                                                            class="d-inline-flex align-items-center justify-content-center bg-success lh-1 rounded-pill w-40px h-40px me-3 text-white">
                                                            <span class="letter-icon"></span>
                                                        </a>
                                                        <div>
                                                            <a href="#"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <a href="#"
                                                            class="d-inline-flex align-items-center justify-content-center bg-pink lh-1 rounded-pill w-40px h-40px me-3 text-white">
                                                            <span class="letter-icon"></span>
                                                        </a>
                                                        <div>
                                                            <a href="#"
                                                                ...
                                                                Castellano</a>
                                                            <div class="d-flex align-items-center text-muted fs-sm">
                                                                <span class="bg-success rounded-pill me-2 p-1"></span>
                                                                Low
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <a href="#"
                                                            class="d-inline-flex align-items-center justify-content-center bg-indigo lh-1 rounded-pill w-40px h-40px me-3 text-white">
                                                            <span class="letter-icon"></span>
                                                        </a>
                                                        <div>
                                                            <a href="#"
                                    ...
                                    <div class="row">
                                        <div class="col-xl-6">
                                            <div class="d-sm-flex align-items-sm-start mb-3">
                                                <a href="#"
                                                    class="d-inline-block position-relative me-sm-3 mb-sm-0 mb-3">
                                                    <img src="../../../assets/images/demo/flat/1.png"
                                                        class="flex-shrink-0 rounded" height="100"
                                                        alt="">
                                                    <div
                                                        class="d-inline-flex bg-dark position-absolute start-50 top-50 translate-middle rounded-pill bg-opacity-50 p-2 text-white">
                                                        <i class="ph-play"></i>
                                                    </div>
                                                    <span
                                                        class="bg-dark fs-xs lh-1 rounded-1 position-absolute bottom-0 start-0 mb-2 ms-2 bg-opacity-50 p-1 text-white">12:25</span>
                                                </a>
                                            ...
                                            <div class="d-sm-flex align-items-sm-start mb-3">
                                                <a href="#"
                                                    ...
                                                    <span
                                                        class="bg-dark fs-xs lh-1 rounded-1 position-absolute bottom-0 start-0 mb-2 ms-2 bg-opacity-50 p-1 text-white">47:25</span>
                                                </a>
                                        ...
                                        <div class="col-xl-6">
                                            <div class="d-sm-flex align-items-sm-start mb-3">
                                                <a href="#"
                                                    ...
                                                    <span
                                                        class="bg-dark fs-xs lh-1 rounded-1 position-absolute bottom-0 start-0 mb-2 ms-2 bg-opacity-50 p-1 text-white">48:40</span>
                                                </a>
                                            ...
                                            <div class="d-sm-flex align-items-sm-start mb-3">
                                                <a href="#"
                                                    ...
                                                    <span
                                                        class="bg-dark fs-xs lh-1 rounded-1 position-absolute bottom-0 start-0 mb-2 ms-2 bg-opacity-50 p-1 text-white">22:14</span>
                                                </a>
                                    ...
                                    <div class="tab-pane active fade show" id="messages-tue">
                                        <div class="d-flex align-items-start mb-3">
                                            <div class="status-indicator-container me-3">
                                                ...
                                                <span class="status-indicator bg-success"></span>
                                                <span
                                                    class="badge bg-yellow position-absolute start-100 translate-middle rounded-pill top-0 text-black">5</span>
                                            </div>
                                        ...
                                        <div class="d-flex align-items-start mb-3">
                                            <div class="status-indicator-container me-3">
                                                ...
                                                <span class="status-indicator bg-danger"></span>
                                                <span
                                                    class="badge bg-yellow position-absolute start-100 translate-middle rounded-pill top-0 text-black">4</span>
                                            </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex mb-3">
                                        <div class="me-3">
                                            <div class="bg-pink text-pink lh-1 rounded-pill bg-opacity-10 p-2">
                                                <i class="ph-chart-line"></i>
                                            </div>
                                        </div>
                                        <div class="flex-fill">
                                    ...
                                    <div class="d-flex mb-3">
                                        <div class="me-3">
                                            <div class="bg-success text-success lh-1 rounded-pill bg-opacity-10 p-2">
                                                <i class="ph-check"></i>
                                            </div>
                                        </div>
                                        <div class="flex-fill">
                                    ...
                                    <div class="d-flex mb-3">
                                        <div class="me-3">
                                            <div class="bg-primary text-primary lh-1 rounded-pill bg-opacity-10 p-2">
                                                <i class="ph-users"></i>
                                            </div>
                                        </div>
                                        <div class="flex-fill">
                                    ...
                                    <div class="d-flex mb-3">
                                        <div class="me-3">
                                            <div class="bg-warning text-warning lh-1 rounded-pill bg-opacity-10 p-2">
                                    ...
                                    <div class="d-flex">
                                        <div class="me-3">
                                            <div class="bg-teal text-teal lh-1 rounded-pill bg-opacity-10 p-2">
                        ...
                        <ul class="nav">
                            ...
                            <li class="nav-item ms-md-1">
                                <a href="https://themeforest.net/item/limitless-responsive-web-application-kit/13080328?ref=kopyov"
                                    class="navbar-nav-link navbar-nav-link-icon text-primary bg-primary fw-semibold rounded bg-opacity-10"
                                    target="_blank">
                                    <div class="d-flex align-items-center mx-md-1">
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="notifications">
        <div class="offcanvas-header py-0">
            ...
            <button type="button" class="btn btn-light btn-sm btn-icon rounded-pill border-transparent"
        ...
        <div class="offcanvas-body p-0">
            <div class="bg-light fw-medium px-3 py-2">New notifications</div>
            <div class="p-3">
                <div class="d-flex align-items-start mb-3">
                    ...
                    <div class="flex-fill">
                        ...
                        <div class="bg-light my-2 rounded p-2">
                ...
                <div class="d-flex align-items-start">
                    <div class="me-3">
                        <div class="bg-warning text-warning rounded-pill bg-opacity-10">
            ...
            <div class="bg-light fw-medium px-3 py-2">Older notifications</div>
            <div class="p-3">
                <div class="d-flex align-items-start mb-3">
                    <a href="#" class="status-indicator-container me-3">
                    ...
                    <div class="flex-fill">
                        ...
                        <div class="bg-light my-2 rounded p-2">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ms-2">
                                    <button type="button"
                                        class="btn btn-flat-dark text-body btn-icon btn-sm rounded-pill border-transparent">
                ...
                <div class="d-flex align-items-start mb-3">
                    <div class="me-3">
                        <div class="bg-success text-success rounded-pill bg-opacity-10">
                ...
                <div class="d-flex align-items-start mb-3">
                    <div class="me-3">
                        <div class="bg-primary text-primary rounded-pill bg-opacity-10">
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="demo_config">
        ...
        <div class="offcanvas-body">
            ...
            <div class="list-group mb-3">
                <label class="list-group-item list-group-item-action form-check border-width-1 mb-2 rounded">
                    <div class="d-flex flex-fill my-1">
                        ...
                        <input type="radio" class="form-check-input ms-auto cursor-pointer" name="main-theme"
                            value="light" checked>
                    </div>
                </label>
                ...
                <label class="list-group-item list-group-item-action form-check border-width-1 mb-0 rounded">
                    <div class="d-flex flex-fill my-1">
                        <div class="form-check-label d-flex me-2">
                ...
                <label class="list-group-item list-group-item-action form-check border-width-1 mb-0 rounded">
                    <div class="d-flex flex-fill my-1">
                        ...
                        <input type="checkbox" name="layout-direction" value="rtl"
                            class="form-check-input m-0 ms-auto cursor-pointer">
                    </div>
                </label>
            </div>
                ...
                <div class="col-12">
                    <a href="index.html" class="d-block mb-3">
                        <img src="https://demo.interface.club/limitless/assets/images/layouts/layout_1.png"
                            class="img-fluid img-thumbnail bg-primary border-primary bg-opacity-20" alt="">
                    </a>
                </div>
                <div class="col-12">
